...
export default class OakItems implements Feature {
    ...
    initialize() {
        this.itemList = [
            new OakItem(OakItemType.Magic_Ball, 'Magic Ball', 'Increases catch rate, including within the Safari Zone',
                true, [5, 6, 7, 8, 9, 10], 0, 20, 2, undefined, undefined, undefined, '%'),
            new OakItem(OakItemType.Amulet_Coin, 'Amulet Coin', 'Earn more Pokédollars from battles, excluding dungeon battles',
                true, [1.25, 1.30, 1.35, 1.40, 1.45, 1.50], 1, 30, 1),
            new OakItem(OakItemType.Rocky_Helmet, 'Rocky Helmet', 'Click Attacks do more damage',
                true, [1.25, 1.30, 1.35, 1.40, 1.45, 1.50], 1, 40, 3),
            new OakItem(OakItemType.Exp_Share, 'EXP Share', 'Gain more Pokémon exp from battling',
                true, [1.15, 1.18, 1.21, 1.24, 1.27, 1.30], 1, 50, 1),
            new OakItem(OakItemType.Sprayduck, 'Sprayduck', 'Increases the growth and wither speed of berries on the Farm',
                false, [1.25, 1.30, 1.35, 1.40, 1.45, 1.50], 1, 60, 1),
            new OakItem(OakItemType.Shiny_Charm, 'Shiny Charm', 'Increases the chance of shiny Pokémon from all sources',
            ...
            new OakItem(OakItemType.Cell_Battery, 'Cell Battery', 'Increases the recharge rate of the Underground Battery',
            ...
            new BoughtOakItem(OakItemType.Explosive_Charge, 'Explosive Charge', 'Increases the number of tiles the Bomb tool can target in the Underground', 'Cinnabar Island Shop',
                true, [1, 2, 3, 6, 8, 10], 1, 50, undefined, undefined, AmountFactory.createArray([50000, 100000, 400000, 1000000, 2000000], Currency.money), ''),
            new BoughtOakItem(OakItemType.Treasure_Scanner, 'Treasure Scanner', 'Chance to multiply mining rewards in the Underground', 'Cinnabar Island Shop',
